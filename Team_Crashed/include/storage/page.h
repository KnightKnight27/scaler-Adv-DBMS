...
public:
    ...
    // Heap-file chain pointer. Pages belonging to the same table form a
    // singly-linked list; nextPage() returns 0 on the last page. The
    // catalog page (id 0) does not use this field, so it stays 0.
    // Stored at offset 20 of the page header — see src/storage/page.cpp
