...
// Follows lab_sessions/lab_5.txt exactly:
//   Part 1: tokenise -> to_rpn -> eval_rpn  (Dijkstra's shunting-yard)
//   Part 2: parse_select() -> execute() over a vector<Row>
...
// ──────────────────────────────────────────────────────────
//  Part 1 — Shunting-Yard (infix expression evaluator)
// ──────────────────────────────────────────────────────────
...
int main() {
    ...
    struct { std::string sql; } queries[] = {
        ...
        { "SELECT name, age FROM students WHERE gpa > 3.4 ORDER BY age" },
    };

    std::cout << "=== Part 2: SQL SELECT executor ===\n";
