...
// ---------------------------------------------------------------------------
// BloomFilter -- a per-LsmSSTable probabilistic membership filter.  maybe_contains
// returns false only if the key is DEFINITELY absent, letting a point lookup
// skip reading an LsmSSTable entirely when the key isn't there.  This is the main
