...
// Types of WAL record.  AxiomDB logs LOGICAL operations (row images keyed by
...
// ---------------------------------------------------------------------------
// LogManager -- the write-ahead log: an append-only, self-framing record
// stream backing crash recovery.
//
//   * append on every modification (logged BEFORE the change can reach disk;
//     see BufferPoolManager's pre-flush sync hook),
