...
// ---------------------------------------------------------------------------
// LruKEvictor - LRU-K page eviction policy.
//
...
// not internally synchronised; the BufferPoolManager calls it under its own latch.
// ---------------------------------------------------------------------------

class LruKEvictor {
 public:
  LruKEvictor(size_t num_frames, size_t k)
