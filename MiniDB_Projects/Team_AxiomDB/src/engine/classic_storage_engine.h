...
// ===========================================================================
// ClassicStorageEngine -- the "classic" storage engine exposed through the shared KV
...
// ===========================================================================
class ClassicStorageEngine : public StorageEngine {
 public:
  explicit ClassicStorageEngine(const std::string& path, size_t buffer_frames = 4096);
  ~ClassicStorageEngine() override;
