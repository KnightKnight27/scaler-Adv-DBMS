// MVCC vs 2PL under read/write contention; same workload run in both modes.
// Built by ./build.sh. To build it on its own (from the project root):
//   g++ -std=c++17 -O2 -pthread -Isrc benchmarks/bench_mvcc_vs_2pl.cpp src/txn/transaction_manager.cpp -o benchmarks/bench
