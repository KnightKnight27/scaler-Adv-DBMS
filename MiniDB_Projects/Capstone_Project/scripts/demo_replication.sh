...
rm -f pri_pipe rep_pipe replica_output.log primary_output.log
...
grep -E "Replica|Results|row\(s\)|key=" replica_output.log | grep -v "Type HELP" || true
echo "------------------------------------------------------------"
