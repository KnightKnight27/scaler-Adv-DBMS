...
int main() {
    ...
    cout << "Inserting records into B-Tree (Degree = 3)..." << endl;
    tree.insert(10, "A");
    tree.insert(20, "B");
    tree.insert(5, "C");
    tree.insert(6, "D");
    ...
    cout << "\nSearching for key 99:" << endl;
    auto result_not_found = tree.search(99);
    if (result_not_found != nullptr) {
        cout << "Found: " << result_not_found->key << endl;
    } else {
