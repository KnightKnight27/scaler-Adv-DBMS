...
int main()
{
    ...
    std::cout << "Inserting values: 10, 20, 30, 15, 25, 5, 1" << std::endl;
    for (int k : values)
        rbt.insert(k);

    std::cout << "Inorder representation (key + color R/B):" << std::endl;
    rbt.print();

    std::cout << "Removing value 20..." << std::endl;
    rbt.remove(20);

    std::cout << "Inorder representation after removing 20:" << std::endl;
    rbt.print();
