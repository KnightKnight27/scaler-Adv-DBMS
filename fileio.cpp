...
//
//  Author: [YOUR_NAME_HERE] ([YOUR_ROLL_NUMBER_HERE])
...
// openat with AT_FDCWD — resolves relative to cwd, modern canonical form
...
int main() {
    ...
    const char* banner  = "=== Output generated by fileio ([YOUR_NAME_HERE], [YOUR_ROLL_NUMBER_HERE]) ===\n\n";
    const char* closing = "\n\n=== Processing complete ===\n";
