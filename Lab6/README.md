...
> The full implementation lives in a single compilable file: [`transaction_manager.cpp`](transaction_manager.cpp). Compile with `g++ -std=c++17 -pthread -o transaction_manager transaction_manager.cpp && ./transaction_manager`.
...
```bash
g++ -std=c++17 -pthread -o transaction_manager transaction_manager.cpp && ./transaction_manager
```
