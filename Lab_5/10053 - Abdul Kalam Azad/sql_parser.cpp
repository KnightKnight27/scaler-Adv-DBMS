// ============================================================
//  Lab Session: Shunting-Yard Algorithm + Minimal SQL SELECT
//               Parser over vector<Row>
//  Name      : Abdul Kalam Azad
//  Roll No.  : 24BCS10053
//  Build     : g++ -std=c++17 -o sql_parser sql_parser.cpp && ./sql_parser
//
//  Part 1: Dijkstra's Shunting-Yard infix -> postfix (RPN) evaluator.
//  Part 2: A minimal SQL SELECT parser/executor that runs queries
//          (WHERE / ORDER BY / LIMIT) against an in-memory vector<Row>.
// ============================================================
...
#include <stdexcept>
#include <cctype>
#include <cmath>        // std::pow  (required by eval_rpn's '^' operator)
#include <variant>
#include <algorithm>
#include <functional>
