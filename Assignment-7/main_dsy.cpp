...
//
// Converts a WHERE clause from infix to postfix (RPN) using an
// operator stack and a precedence table, then evaluates the postfix
// expression with a single integer stack to filter rows.
