...
### 1. [PostgreSQL vs SQLite Architecture Comparison](file:///home/samarth/Desktop/Sansu/scaler-Adv-DBMS/System_Design_Docs/PostgreSQL_vs_SQLite/README.md)
...
### 2. [PostgreSQL Internal Architecture](file:///home/samarth/Desktop/Sansu/scaler-Adv-DBMS/System_Design_Docs/PostgreSQL_Internals/README.md)
...
* **Key Internals Covered**:
  ...
  - **nbtree Indexing**: The Lehman-Yao B-tree concurrent modification algorithm (right-link chains, page high-keys, lock-free descent), deduplication, and the visibility map for index-only scans.
  ...
  - **WAL Subsystem**: Write-ahead log structure, Log Sequence Numbers (LSN), full-page writes for torn-page protection, and crash recovery redo logic.
  - **Query Planner**: Cost-based optimizer, statistics collection (`pg_statistic`), join strategy selection, and selectivity estimation.

### 3. [MySQL InnoDB Storage Engine](file:///home/samarth/Desktop/Sansu/scaler-Adv-DBMS/System_Design_Docs/MySQL_InnoDB/README.md)
...
### 4. [RocksDB LSM-Tree Storage Engine](file:///home/samarth/Desktop/Sansu/scaler-Adv-DBMS/System_Design_Docs/RocksDB/README.md)
