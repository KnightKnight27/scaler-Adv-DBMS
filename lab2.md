hey i have assignment but i dont have problem statment but i have someone elses solution so check this and create me a similar type of solution will all those things in this change soem things make sure project is same # scaler-Adv-DBMS
...
```
-rw-r--r--@ 1 harshashetty  staff    34M 10 May 00:53 users.db
```
...
```
harshashetty  33652   0.0  0.0 435299904   1344 s013  S+    1:15AM   0:00.01 grep sqlite
```
...
```
harshashetty  33174  ... postgres: harshashetty postgres [local] idle
harshashetty  32001  ... postgres: logical replication launcher
harshashetty  32000  ... postgres: autovacuum launcher
harshashetty  31999  ... postgres: walwriter
harshashetty  31997  ... postgres: background writer
harshashetty  31996  ... postgres: checkpointer
harshashetty  31993  ... /opt/homebrew/opt/postgresql@17/bin/postgres -D /opt/homebrew/var/postgresql@17
```
