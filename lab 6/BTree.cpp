...
int main()
{
    ...
    std::cout << "Inserting values: 10, 20, 5, 6, 12, 30, 7, 17, 3, 1, 25" << std::endl;
    for (int k : values)
        bt.insert(k);

    std::cout << "Inorder after inserts:" << std::endl;
    bt.print();

    std::cout << "Searching for key 17: "
    ...
    std::cout << "Inorder after removing 6 and 20:" << std::endl;
    bt.print();
