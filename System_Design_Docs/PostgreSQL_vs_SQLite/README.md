...
khushi  6067  /opt/homebrew/opt/postgresql@15/bin/postgres -D /opt/homebrew/var/postgresql@15
khushi  6076  postgres: checkpointer
khushi  6077  postgres: background writer
khushi  6079  postgres: walwriter
khushi  6080  postgres: autovacuum launcher
khushi  6081  postgres: logical replication launcher
```
