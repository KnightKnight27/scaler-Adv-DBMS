...
3. **AST**: A single tagged `Expr` struct (`Column` / `Number` / `BinOp`) rather than a virtual class hierarchy. This ensures the evaluator is short and does not require complex type casting.
