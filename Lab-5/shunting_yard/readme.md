...
The parser's tree can carry metadata a flat list cannot, which is why most real planners use one; the shunting-yard is lighter and handy for standalone expression evaluation.
