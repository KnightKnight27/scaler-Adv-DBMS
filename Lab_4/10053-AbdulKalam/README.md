...
| `0x60` to `0x63` | `00 2e 86 29` | SQLite library version number stored in the file |
...
```text
00000060: 00 2e 86 29 0d 00 00 00 01 0f 5b 00 0f 5b 00 00  ...)......[..[..
```
...
```text
31 01 06 00 17 2d 37 01 31 30 30 35 33 41 62 64 75 6c 20 4b 61 6c 61 6d 20 41 7a 61 64 ...
```
