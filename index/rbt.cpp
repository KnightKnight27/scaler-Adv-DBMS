...
//   Build: g++ -std=c++17 -o rbt rbt.cpp && ./rbt
//
// Invariants: (1) every node is RED or BLACK, (2) root is BLACK,
// (3) a RED node has no RED child, (4) every root->NULL path has the same
// number of BLACK nodes. These guarantee O(log n) height.
#include <iostream>
