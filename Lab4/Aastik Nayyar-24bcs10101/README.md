...
```text
00001000: 0d 00 00 00 03 0f dc 00 0f f4 0f ea 0f dc
```
...
```text
0c 03 04 00 1b 01 43 68 61 72 6c 69 65 17
```
...
```text
00001fd6: 00 00 00 00 00 00 0c 03 04 00 1b 01 43 68 61 72
00001fe6: 6c 69 65 17 08 02 04 00 13 01 42 6f 62 16
00001ff6: 04 00 17 01 41 6c 69 63 65 15
```
