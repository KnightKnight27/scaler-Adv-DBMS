// Lab Session 4 — Part 1: Red-Black Tree in C++
//
// A self-balancing BST (the structure behind std::map and in-memory DB indexes).
// Invariants: nodes are Red/Black; root is Black; no two consecutive Reds; every
// root-to-NULL path has the same number of Black nodes => O(log n) height.
//
// Build:  g++ -std=c++17 -Wall -Wextra -O2 -o rbt rbt.cpp
// Run:    ./rbt
